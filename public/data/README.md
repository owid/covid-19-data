> ⚠️ **7 January 2021 23:00 GMT** – We're currently unable to update our charts and maps on [ourworldindata.org](https://ourworldindata.org) due to an issue with our hosting provider Netlify. We hope to solve this as fast as possible. **However, our latest COVID-19 data (including data on vaccinations) is already live in this GitHub repository. If you rely on our GitHub dataset for journalism or research, this issue does not affect you. In particular, we'll continue to push regular updates of the vaccination data to GitHub until this is resolved, and even if our own charts are not updated.** The contents of our [COVID-19 data explorer](https://ourworldindata.org/coronavirus-data-explorer) are also hosted separately and are not affected, so you can visualize the latest data on confirmed cases, deaths, and tests without any problem.
